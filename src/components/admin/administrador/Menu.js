    ...
    return (
      <div className="menu-admin">
        ...
        >
          <Menu.Item key="1">
          <Icon type="user" />
            <span className="span-menu"> <Link  className="span-menu" to="/admin">Distribuidores</Link></span>
          </Menu.Item>


          <Menu.Item key="2">
          <Icon type="user" />
            <span className="span-menu"> <Link  className="span-menu" to="/ventas">Ventas</Link></span>
          </Menu.Item>
